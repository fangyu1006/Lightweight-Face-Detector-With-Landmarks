...
if __name__ == "__main__":
    onnx_path = "./converted_models/mobilenet/mobilenetv3_sim.onnx"
    prototxt_path = "./converted_models/mobilenet/mobilenetv3.prototxt"
    caffemodel_path = "./converted_models/mobilenet/mobilenetv3.caffemodel"
